...
@push('styles')
@include('partials._multifile_css', ['editorHeight' => '480px', 'previewHeight' => '480px'])
<style>
...
<div x-data="examApp({{ $exam->id }}, {{ $remainingSeconds ?? 'null' }})" x-init="init()">
    ...
    <div class="bg-blue-50 border border-blue-200 rounded p-3 mb-4 text-sm text-gray-700">
    ...
    <div class="grid grid-cols-5 gap-4">
        ...
        <div class="col-span-2">
            <div class="bg-gray-100 text-gray-500 text-xs px-3 py-1 rounded-t flex items-center gap-1">
